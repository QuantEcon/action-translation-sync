...
export class ReportGenerator {
  ...
  toMarkdown(report: DiagnosticReport): string {
    ...
    lines.push('  - Section count mismatch:     -20 per missing/extra section');
    lines.push('  - Subsection count mismatch:  -10 per missing/extra subsection');
    lines.push('  - Code block count mismatch:  -15 (if counts differ)');
    lines.push('  - Math block count mismatch:  -15 (if counts differ)');
    lines.push('');
